...
alias bi='buku --ai'
alias bp='buku --print'
alias bl='buku --lock 15'
alias bu='buku --unlock 15'
alias fz='vim $(fzf)'
...
alias gpa='for i in $(find ~/repos/ -type d -name ".git" ! -path "*personal/docker-compose/data/*") ; do cd $i/../ ; echo $PWD ; git pull ; echo ; done'
alias gpp='git pull'
