...
alias ipa='ip -family inet -oneline addr | grep dynamic'
alias pf='pip freeze'
...
alias bl='7z a -p`cat ~/.bukupasswd` ~/repos/personal/buku/bookmarks.db.7z ~/.local/share/buku/bookmarks.db'
alias bu='cd ~/repos/personal/buku ; 7z x -p`cat ~/.bukupasswd` ~/repos/personal/buku/bookmarks.db.7z ; mv ~/repos/personal/buku/bookmarks.db ~/.local/share/buku/'
