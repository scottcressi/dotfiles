...
alias ggsa='for i in $(find ~/repos/ -maxdepth 2 -mindepth 2 -type d) ; do echo $i ; git -C $i branch | grep "*" ; done'
alias gl='git log'
...
alias gpa='for i in $(find ~/repos/ -maxdepth 2 -mindepth 2 -type d) ; do echo $i ; git -C $i pull ; done'
alias gpp='git pull'
alias gpu='git push origin `git rev-parse --abbrev-ref HEAD`'
alias gs='git status'
alias gsa='for i in $(find ~/repos/ -maxdepth 2 -mindepth 2 -type d) ; do echo $i ; git -C $i status ; done'
alias gstat='for i in $(find ~/repos/ -maxdepth 2 -mindepth 2 -type d) ; do echo $i ; git -C $i shortlog -s -n --all --no-merges ; done'
alias gt='git tag -l'
...
alias taa='terraform init && terraform apply -auto-approve'
