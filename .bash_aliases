...
alias ggsa='for i in $(find ~/repos -type d -name .git | grep -v .terraform | grep -v modules_forge) ; do cd $i/../ ; echo $i ; git status | grep "On branch" | grep -v master ; echo ; done'
alias gl='git log'
...
alias gpa='for i in $(find ~/repos/ -type d -name .git | grep -v .terraform | grep -v modules_forge) ; do cd $i/../ ; echo $PWD ; git pull ; echo ; done'
alias gpp='git pull'
alias gpu='git push origin `git rev-parse --abbrev-ref HEAD`'
alias gs='git status'
alias gsa='for i in $(find ~/repos/ -type d -name .git | grep -v .terraform | grep -v modules_forge) ; do cd $i/../ ; echo $PWD ; git status ; echo ; done'
alias gstat='for i in $(find ~/repos -type d -name .git | grep -v .terraform | grep -v modules_forge) ; do cd $i/../ ; pwd ; git shortlog -s -n --all --no-merges ; done'
alias gt='git tag -l'
