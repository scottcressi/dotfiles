...
alias gt='git tag -l'
alias gpa='for i in `find ~/repos -name .git | grep -v forge` ; do cd $i/../ ; pwd ; git pull ; done'
alias gs='git status'
alias gsa='for i in `find ~/repos -name .git | grep -v forge` ; do cd $i/../ ; pwd ; git status ; done'
